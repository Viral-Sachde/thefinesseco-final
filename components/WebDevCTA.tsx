...
export const WebDevCTA: React.FC<WebDevCTAProps> = ({ onNavigate }) => {
  return (
    <div className="bg-eddie-purple rounded-[1.5rem] sm:rounded-[2rem] md:rounded-[2.5rem] p-8 sm:p-12 md:p-16 lg:p-24 text-center relative overflow-hidden group cursor-pointer" onClick={() => onNavigate('contact')}>
       ...
       <div className="relative z-10">
          ...
          <button className="bg-white text-eddie-purple px-6 sm:px-8 py-3 sm:py-4 rounded-full font-bold text-base sm:text-lg hover:scale-105 transition-transform shadow-lg">
            Book a Call
          </button>
       </div>
    </div>
