...
export const VideoShowcase: React.FC = () => {
  return (
    <div className="w-full max-w-6xl mx-auto px-4 mt-8 mb-16 animate-slide-up" style={{ animationDelay: '0.2s' }}>
      <div className="relative w-full aspect-video bg-black rounded-[2.5rem] overflow-hidden group cursor-pointer shadow-2xl">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center z-10">
          <div className="w-20 h-20 md:w-24 md:h-24 bg-white/10 backdrop-blur-md rounded-full flex items-center justify-center border border-white/20 group-hover:scale-110 transition-transform duration-300 group-hover:bg-white/20">
        ...
        <div className="absolute bottom-8 left-8 right-8 flex justify-between items-end z-10">
           ...
           <div className="hidden md:flex items-center gap-2 text-white/80 font-mono text-xs">
             <span>00:00</span>
